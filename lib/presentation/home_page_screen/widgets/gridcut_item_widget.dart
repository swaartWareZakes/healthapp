...
class GridcutItemWidget extends StatelessWidget {
  int index;
  GridcutItemWidget({Key? key, required this.index}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color: getColor(index), shape: BoxShape.circle),
  ...
  Color getColor(int index) {
    ...
    else if (index == 2) return ColorConstant.deepPurple50;
  ...
  void onSectionTap(BuildContext context) {
    if (index == 0) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ApplyCovidTestScreen()),
      );
    } else if (index == 1) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => NearestHospitalScreen()),
      );
    } else if (index == 3) {
      Navigator.push(
        context,
