                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  if (index == 0) {
                                    // Navigate to Neurological Exam screen
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            DoctorsListScreen(), // Change to your specific screen
                                      ),
                                    );
                                  } else {
                                    // Show a message for other services
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                            'Only Neurological Exam is functional'),
                                      ),
                                    );
                                  }
                                },
                                child: GridcutItemWidget(
                                  index: index,
                                ),
                              );
                            },
