...
class GridglobeItemWidget extends StatelessWidget {
  int index;
  GridglobeItemWidget({Key? key, required this.index}) : super(key: key);
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              decoration:
                  BoxDecoration(color: getColor(index), shape: BoxShape.circle),
              child: Text(
                (index + 1).toString(),
                overflow: TextOverflow.ellipsis,
  ...
  Color getColor(int index) {
    ...
    else if (index == 5) return ColorConstant.deepOrangeA200;
