...
class PatientUpdateScreen extends StatelessWidget {
  const PatientUpdateScreen({Key? key}) : super(key: key);
      ...
      body: SafeArea(
        child: Column(
          children: [
            Container(
              width: size.width,
              margin: getMargin(right: 20, left: 20, top: 20, bottom: 0),
              child: Row(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: getPadding(top: 16, right: 10, bottom: 16),
                        child: Text(
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CommonImageView(
                              imagePath: ImageConstant.imgTopviewmedica,
                              height: getVerticalSize(
                                260.00,
                              ),
                              width: getHorizontalSize(
