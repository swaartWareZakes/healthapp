...
class CommonImageViewWithDarkOption extends StatefulWidget {
  ...
  @override
  State<CommonImageViewWithDarkOption> createState() =>
      _CommonImageViewWithDarkOption();
}

class _CommonImageViewWithDarkOption
    extends State<CommonImageViewWithDarkOption> {
  @override
  Widget build(BuildContext context) {
    return _buildImageView(context);
  }
